...
img1=tf(Image.open("test_img/wangjianlin/1.jpg")).to(DEVICE)
vector1=net.register(img1[None,...])
img2=tf(Image.open("test_img/wangjianlin/5.jpg")).to(DEVICE)
